...
describe('Insertion sort', () => {
    test('should sort array of number in ascending order', () => {
        ...
        expect(insertionSort([2, 4, 6, 1, 9, 3, 1, 5])).toStrictEqual([1, 1, 2, 3, 4, 5, 6, 9]);
        expect(insertionSort([2, -4, 6, 1])).toStrictEqual([-4, 1, 2, 6]);
        expect(insertionSort([-9, -3, -1, -5])).toStrictEqual([-9, -5, -3, -1]);
    });
