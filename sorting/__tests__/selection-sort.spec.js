...
describe('Selection sort', () => {
    test('should sort array of number in ascending order', () => {
        ...
        expect(selectionSort([2, 4, 6, 1, 9, 3, 1, 5])).toStrictEqual([1, 1, 2, 3, 4, 5, 6, 9]);
        expect(selectionSort([2, -4, 6, 1])).toStrictEqual([-4, 1, 2, 6]);
        expect(selectionSort([-9, -3, -1, -5])).toStrictEqual([-9, -5, -3, -1]);
    });
